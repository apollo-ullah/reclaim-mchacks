...
function SignPage() {
    _s();
    const { creator, isAuthenticated, isLoading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleImageSelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SignPage.useCallback[handleImageSelect]": (file)=>{
            setSelectedFile(file);
            setResult(null);
            // Create preview
            const reader = new FileReader();
            reader.onload = ({
                "SignPage.useCallback[handleImageSelect]": (e)=>{
                    setPreview(e.target?.result);
                }
            })["SignPage.useCallback[handleImageSelect]"];
...
_s(SignPage, "3lhabdjoKAEEjjwhLnIRg/j1l7o=", false, function() {
    return [
...
//# sourceMappingURL=_fcea89d3._.js.map